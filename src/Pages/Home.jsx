...
const Home = () => {
  ...
  return (
    <div>
      ...
      >
        <h1 className=" text-2xl md:text-4xl py-3 font-bold text-center">Get news for new blog post</h1>
        <form onSubmit={handleNewslatter} action="">
            <input type="email" required className="py-2 w-40 md:w-auto px-4 rounded-l-md" placeholder="email" />
            <input type="submit" className="py-2 px-3 rounded-r-md bg-sky-600 text-white" value='Subscribe' />
        </form>
